...
(function(window,undefined){
	...
	mojo.fn = mo.prototype = {
		 ...
		 * @param {Function} callback
		 */
		elems : function(callback){
			callback.call(this,this.ems);
			return this;
		},
	...
	jo = {
		/**
		 * 根据选择器初始化mojo对象
		 * @param {Object or String} selector
		 */
